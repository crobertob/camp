...
%
% Copyright, CAMP, Technische Universität München
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% TODO - OPTIONAL - BONUS
% Multi-resolution 
% Implement a Gaussian pyramid to create multi-level images.
% Start with registration at the coarsest level and propagate
% obtained transformation parameters to finer levels.
% Be careful about the image size changes and parameter values.
